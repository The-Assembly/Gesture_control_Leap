...
int indexMiddleServo = 11; //Index & Middle
int ringPinkyServo = 10; //Ring
...
void setup()
{
    ...
    //Uncomment line below and put value of port arduino is connect to
    ...
    for (Finger finger : frame.fingers()) {
       ...
       switch (fingerType){
          ...
          case TYPE_RING:
               ...
               //Get direction of metacarpal bone
               
               //Get direction of distal bone
               
               //Calculate angle between metacarpel and distal bone; convert to degrees
